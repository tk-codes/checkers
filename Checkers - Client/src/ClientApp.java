...
public class ClientApp extends JFrame{	
	...
	public ClientApp(){
		...
		address = (String) JOptionPane.showInputDialog(null,"Enter Server IPv4-address","Connect to Server",
		...
		if(address!=null && address.length()>0){
			...
			JOptionPane.showMessageDialog(null, "Please enter valid IPv4-Address",
			"Error", JOptionPane.ERROR_MESSAGE, null);
			System.exit(0);
		}
	}
	...
	private void connect(){
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Internal Server Error - Check your IPv4-Address",
					"Error", JOptionPane.ERROR_MESSAGE, null);
			System.exit(0);
		} catch (IOException e) {
			JOptionPane.showMessageDialog(null, "Couldn't connect to Server. Please try again",
					"Error", JOptionPane.ERROR_MESSAGE, null);
			System.exit(0);
		}
	}
